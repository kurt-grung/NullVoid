...
const RULE_DEFINITIONS = {
  ...
  'DEPENDENCY_CONFUSION_TIMELINE': {
    id: 'DEPENDENCY_CONFUSION_TIMELINE',
    name: 'Dependency Confusion Timeline Analysis',
    shortDescription: {
      text: 'Detects suspicious timing between package creation and git history'
    },
    fullDescription: {
      text: 'Identifies packages where the npm registry creation date is suspiciously close to the first git commit, indicating potential dependency confusion attacks.'
    },
    help: {
      text: 'This package was created suspiciously close to its first git commit. Verify the package authenticity and consider using private registries for internal packages.'
    },
    helpUri: 'https://github.com/kurt-grung/NullVoid#dependency-confusion-detection',
    properties: {
      tags: ['security', 'supply-chain', 'dependency-confusion', 'timeline'],
      precision: 'high',
      severity: 'error'
    }
  },
  'DEPENDENCY_CONFUSION_PATTERN': {
    id: 'DEPENDENCY_CONFUSION_PATTERN',
    name: 'Dependency Confusion Pattern Detection',
    shortDescription: {
      text: 'Detects suspicious package naming patterns'
    },
    fullDescription: {
      text: 'Identifies packages with naming patterns commonly used in dependency confusion attacks, such as typosquatting or namespace confusion.'
    },
    help: {
      text: 'This package follows suspicious naming patterns. Verify the package name and consider using scoped packages for internal dependencies.'
    },
    helpUri: 'https://github.com/kurt-grung/NullVoid#dependency-confusion-detection',
    properties: {
      tags: ['security', 'supply-chain', 'dependency-confusion', 'naming'],
      precision: 'medium',
      severity: 'warning'
    }
  },
  'DEPENDENCY_CONFUSION_SCOPE': {
    id: 'DEPENDENCY_CONFUSION_SCOPE',
    name: 'Dependency Confusion Scope Analysis',
    shortDescription: {
      text: 'Detects private scope packages vulnerable to dependency confusion'
    },
    fullDescription: {
      text: 'Identifies private scoped packages that may be vulnerable to dependency confusion attacks due to improper npm registry configuration.'
    },
    help: {
      text: 'This private scoped package may be vulnerable to dependency confusion. Ensure proper npm registry configuration and consider using .npmrc files.'
    },
    helpUri: 'https://github.com/kurt-grung/NullVoid#dependency-confusion-detection',
    properties: {
      tags: ['security', 'supply-chain', 'dependency-confusion', 'scope'],
      precision: 'high',
      severity: 'error'
    }
  },
  'DEPENDENCY_CONFUSION_ACTIVITY': {
    id: 'DEPENDENCY_CONFUSION_ACTIVITY',
    name: 'Dependency Confusion Activity Analysis',
    shortDescription: {
      text: 'Detects packages with suspiciously low git activity'
    },
    fullDescription: {
      text: 'Identifies packages with very low git activity that may indicate typosquatting, abandoned packages, or dependency confusion attacks.'
    },
    help: {
      text: 'This package has suspiciously low git activity. Verify the package authenticity and consider alternative packages with more active development.'
    },
    helpUri: 'https://github.com/kurt-grung/NullVoid#dependency-confusion-detection',
    properties: {
      tags: ['security', 'supply-chain', 'dependency-confusion', 'activity'],
      precision: 'medium',
      severity: 'warning'
    }
  },
  'DEPENDENCY_CONFUSION_ERROR': {
    id: 'DEPENDENCY_CONFUSION_ERROR',
    name: 'Dependency Confusion Analysis Error',
    shortDescription: {
      text: 'Error occurred during dependency confusion analysis'
    },
    fullDescription: {
      text: 'An error occurred while analyzing the package for dependency confusion patterns. This may indicate network issues or package access problems.'
    },
    help: {
      text: 'Dependency confusion analysis failed. Check network connectivity and package accessibility.'
    },
    helpUri: 'https://github.com/kurt-grung/NullVoid#dependency-confusion-detection',
    properties: {
      tags: ['security', 'supply-chain', 'dependency-confusion', 'error'],
      precision: 'low',
      severity: 'note'
    }
  }
